...
module main_memory #(
    ...
    parameter MEM_AWIDTH   = $clog2(MEM_WORDS)
)(
    input wire clk,
    input wire reset,
    ...
    assign saved_word_addr =
        saved_addr[OFFSET_WIDTH + MEM_AWIDTH - 1:
                   OFFSET_WIDTH];
             ...
             */
                ...
                if (counter > 1) begin
                    ...
                    if (saved_write) begin
                        ...
                        memory[saved_word_addr]
                            <= saved_wdata;

                        $display(
                            "[MEM WRITE] t=%0t addr=%h data=%h",
                            $time,
                            saved_addr,
                            saved_wdata
                        );
