...
module cache_controller #(
    ...
    assign req_tag =
        req_addr[ADDR_WIDTH-1:
                 OFFSET_WIDTH + INDEX_WIDTH];

    assign req_index =
        req_addr[OFFSET_WIDTH + INDEX_WIDTH - 1:
                 OFFSET_WIDTH];
 ...
 * This prevents the memory from re-accepting a completed
...
always @(*) begin
    ...
    case (state)
        ...
        WRITE_BACK: begin
            ...
            /*
             * Stop asserting request once memory
        ...
        ALLOCATE: begin
            ...
            /*
             * Read requested word from memory.
             */
